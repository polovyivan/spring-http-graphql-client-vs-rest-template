...
import com.polovyi.ivan.client.GraphQLClient;
...
@RestController
@RequestMapping("/v1/for-graphql-client")
public record CustomerControllerForGraphQLClient(GraphQLClient graphQLClient) {
    ...
    public List<CustomerResponse> getAllCustomersWithFilters(
        ...
        return graphQLClient.getCustomersWithFilters(fullName, phoneNumber, createdAt);
    }
    ...
    public void createCustomer(@Valid @RequestBody CreateCustomerRequest createCustomerRequest,
        ...
        String location = graphQLClient.createCustomer(createCustomerRequest);
    ...
    public void updateCustomer(@PathVariable String customerId,
        ...
        graphQLClient.updateCustomer(customerId, updateCustomerRequest);
    }
    ...
    public void partiallyUpdateCustomer(@PathVariable String customerId,
        ...
        graphQLClient.partiallyUpdateCustomer(customerId, partiallyUpdateCustomerRequest);
    }

    @DeleteMapping(path = "/customers/{customerId}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteCustomer(@PathVariable String customerId) {
        graphQLClient.deleteCustomer(customerId);
    }
